...
<table border = "1" align="center" width="70%" height="100%" >
    <tr>
     ...
     <b> Name             :</b>  <input type="text" name="name" value="" /> <br> <br>
     <b> Email            :</b>  <input type="text" name="name" value="" /> <br> <br>
     <b> Phone            :</b>  <input type="text" name="name" value="" /> <br> <br>
     <b> Date of birth    :</b>  <input type="text" name="name" value="" /> <br> <br>
     <b> Gender           :</b>  <input type="text" name="name" value="" /> <br> <br>
